...
public class  VideoPlayerRecyclerView  extends RecyclerView  {
    ...
    // ui
    private ImageView thumbnail, volumeControl,shareBtn,likeBtn,commentBtn,likeAnimate,download,soundDisk;
    ...
    // vars
    private ArrayList<RetrivingData> mediaObjects = new ArrayList<>();
...
//        apiInterface = ApiClient.getApiClient().create(ApiInterface.class);
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        Glide.with(context).load(R.drawable.spin_black_cd).into(soundDisk);
...
//                Glide.with(context).load(R.drawable.ic_volume_off_grey_24dp).into(volumeControl);
                Glide
                        ...
                        .centerCrop()
                        .placeholder(R.drawable.ic_volume_off_grey_24dp)
                        .into(volumeControl);
    ...
    public void setMediaObjects(ArrayList<RetrivingData> mediaObjects){
